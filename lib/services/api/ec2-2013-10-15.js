...
module.exports = {
  ...
  waiters: {
    ...
    __InstanceState: {
      ...
      acceptorPath: 'Reservations[].Instances[].State.Name'
    },
    instanceRunning: {
    ...
    __ExportTaskState: {
      ...
      acceptorPath: 'ExportTasks[].State'
    },
    exportTaskCompleted: {
    ...
    exportTaskCancelled: {
      extends: '__ExportTaskState',
      successValue: 'cancelled'
    },
    snapshotCompleted: {
      operation: 'DescribeSnapshots',
      successPath: 'Snapshots[].State',
      successValue: 'completed'
    },
    subnetAvailable: {
      operation: 'DescribeSubnets',
      successPath: 'Subnets[].State',
      successValue: 'available'
    },
    __VolumeStatus: {
      operation: 'DescribeVolumes',
      acceptorPath: 'VolumeStatuses[].VolumeStatus.Status'
    },
    volumeAvailable: {
    ...
    volumeDeleted: {
      extends: '__VolumeStatus',
      successValue: 'deleted'
    },
    vpcAvailable: {
      operation: 'DescribeVpcs',
      successPath: 'Vpcs[].State',
      successValue: 'available'
    },
    __VpnConnectionState: {
      operation: 'DescribeVpnConnections',
      acceptorPath: 'VpnConnections[].State'
    },
    ...
    bundleTaskComplete: {
      ...
      acceptorPath: 'BundleTasks[].State',
    ...
    __ConversionTaskState: {
      ...
      acceptorPath: 'ConversionTasks[].State'
    },
    ...
    __CustomerGatewayState: {
      ...
      acceptorPath: 'CustomerGateways[].State'
    },
